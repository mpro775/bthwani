...
const controller = __importStar(require("../../controllers/delivry/DeliveryProductSubCategoryController"));
const verifyAdmin_1 = require("../../middleware/verifyAdmin"); // ✅ إضافة الحماية
